...
function setup() {
  ...
  /*escreva o código certo para acionar a função "handleButtonPress" 
  ao clicar no botão "breakButton"
  */
}
...
function handleButtonPress() {
  /*coloque o código certo para quebrar a ponte 
  e ativar o método break depois de um certo tempo usando 
  o setTimeout()
  */
}
